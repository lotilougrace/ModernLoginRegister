...
TextInputEditText textInputEditTextname, textInputEditTextemail, textInputEditTextpassword, textInputEditPhone, textInputEditTextaddress;
Button button1;
Button btnLogRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputEditPhone=findViewById(R.id.mobile);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mobile = String.valueOf(textInputEditPhone.getText());
                ...
                if (!name.equals("") && !email.equals("") && !password.equals("") && !mobile.equals("") && !address.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            //int mobile = Integer.parseInt(tempmobile);
                            ...
                            data[3] = mobile;
                            data[4] = address;
                            PutData putData = new PutData("http://192.168.1.42/LoginRegister/signup.php", "POST", field, data);
                            if (putData.startPut()) {
